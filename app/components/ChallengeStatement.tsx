export default function Challenge() {
    return (
      <section className="text-center mx-auto mt-8 md:mt-12 lg:mt-16 max-w-3xl px-4">
        <h3 className="text-2xl font-bold mb-4">Challenge</h3>
        <p className="text-black">
            Our project is dedicated to strengthening the resilience of marginalized communities against the rising threat of extreme heat - 
            these populations include those experiencing homelessness, without air conditioning, or any populations that cannot combat the 
            severe heat. We are emphasizing climate justice by centering our solution to the needs of communities that are most at risk, 
            offering a solution rooted in proactive care and equitable access to climate adaptation resources.
        </p>
        <br></br>
        <p className="text-black">
